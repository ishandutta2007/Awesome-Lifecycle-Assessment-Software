<p align="center">
  <img src="assets/banner.svg" alt="Awesome Lifecycle Assessment Software Banner" width="100%" />
</p>
...
| :--- | :--- | :--- |
| **[Activity-Browser](https://github.com/Activity-Browser/activitybrowser)** | Open-source graphical user interface (GUI) for the Brightway2 LCA framework, enabling intuitive process modeling and matrix calculations. | [![Stars](https://img.shields.io/github/stars/Activity-Browser/activitybrowser?style=social&color=white)](https://github.com/Activity-Browser/activitybrowser/stargazers) |
| **[Brightway2 Framework](https://github.com/brightway-lca/brightway2)** | Leading modular Python framework for life cycle assessment, optimized for high-performance matrix calculations and large LCI databases. | [![Stars](https://img.shields.io/github/stars/brightway-lca/brightway2?style=social&color=white)](https://github.com/brightway-lca/brightway2/stargazers) |
| **[openLCA Desktop App](https://github.com/GreenDelta/olca-app)** | Full-featured, modular open-source desktop application for modeling life cycle systems, calculating impact categories, and working with ecoinvent/ILCD data. | [![Stars](https://img.shields.io/github/stars/GreenDelta/olca-app?style=social&color=white)](https://github.com/GreenDelta/olca-app/stargazers) |
| **[Premise Prospective LCA](https://github.com/polca-lca/premise)** | Open-source Python package for integrating prospective energy & climate scenario models (IAMs) into background LCA databases. | [![Stars](https://img.shields.io/github/stars/polca-lca/premise?style=social&color=white)](https://github.com/polca-lca/premise/stargazers) |
| **[bw2data](https://github.com/brightway-lca/bw2data)** | Core data management and inventory storage layer for the Brightway2 LCA calculation engine. | [![Stars](https://img.shields.io/github/stars/brightway-lca/bw2data?style=social&color=white)](https://github.com/brightway-lca/bw2data/stargazers) |
| **[olca-ipc.py Client](https://github.com/GreenDelta/olca-ipc.py)** | Python inter-process communication (IPC) client for automating openLCA, running scripts, and interfacing external software. | [![Stars](https://img.shields.io/github/stars/GreenDelta/olca-ipc.py?style=social&color=white)](https://github.com/GreenDelta/olca-ipc.py/stargazers) |
| **[BONSAI Open Database](https://github.com/BONSAMURAIS/bonsai)** | Open-source data architecture and algorithms for creating an independent, transparent global LCI database. | [![Stars](https://img.shields.io/github/stars/BONSAMURAIS/bonsai?style=social&color=white)](https://github.com/BONSAMURAIS/bonsai/stargazers) |
| **[olca-schema](https://github.com/GreenDelta/olca-schema)** | Data format schema definitions (JSON-LD) for openLCA data exchange, data providers, and system boundary definitions. | [![Stars](https://img.shields.io/github/stars/GreenDelta/olca-schema?style=social&color=white)](https://github.com/GreenDelta/olca-schema/stargazers) |
| **[bw2calc Engine](https://github.com/brightway-lca/bw2calc)** | Fast matrix calculation engine powered by SciPy and NumPy for solving life cycle inventory supply systems. | [![Stars](https://img.shields.io/github/stars/brightway-lca/bw2calc?style=social&color=white)](https://github.com/brightway-lca/bw2calc/stargazers) |
| **[bw_timex Extension](https://github.com/brightway-lca/bw_timex)** | Time-explicit LCA engine for Brightway, matching background process inventories to specific temporal timestamps. | [![Stars](https://img.shields.io/github/stars/brightway-lca/bw_timex?style=social&color=white)](https://github.com/brightway-lca/bw_timex/stargazers) |
| **[brightway2-io Parsers](https://github.com/brightway-lca/brightway2-io)** | Input and output data parsers for SimaPro CSV, Ecospold 1/2, Excel, and Simapro inventory files into Brightway2. | [![Stars](https://img.shields.io/github/stars/brightway-lca/brightway2-io?style=social&color=white)](https://github.com/brightway-lca/brightway2-io/stargazers) |
...
[![Star History Chart](https://star-history.dera.page/svg?repos=ishandutta2007/Awesome-Lifecycle-Assessment-Software&type=date&legend=top-left)](https://star-history.dera.page/#ishandutta2007/Awesome-Lifecycle-Assessment-Software&type=date&legend=top-left)
